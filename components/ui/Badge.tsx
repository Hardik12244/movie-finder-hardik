    ...
    <div
      className={cn(
        "inline-flex items-center rounded-[var(--radius-sm)] px-[var(--space-2)] py-[2px] text-[12px] font-semibold tracking-[0.06em] uppercase",
        {
          ...
          "bg-[rgba(8,9,12,0.75)] backdrop-blur-[8px] [-webkit-backdrop-filter:blur(8px)] text-[var(--color-text-primary)] normal-case tracking-normal font-normal": variant === 'rating',
